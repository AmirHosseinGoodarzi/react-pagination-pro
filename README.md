...
<table>
    ...
    <tr>
        <td>state</td>
        <td style="text-align:center">React.State //ex: {page(int or string):1,take(int or string):1}</td>
        <td style="text-align:center">null</td>
        <td>true</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>buttonsText</td>
        <td style="text-align:center">Object //ex: {{ prev: "<<", next: ">>" }} or you can use Icons</td>
        <td style="text-align:center">null</td>
        <td>false</td>
    </tr>
    <tr>
        <td>takeChangerCounts</td>
        <td style="text-align:center">Array //ex: [10,50,100]</td>
        <td style="text-align:center">null</td>
        <td>false</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="text-align:center">String //ex: "Rows"</td>
        <td style="text-align:center">null</td>
        <td>false</td>
    </tr>
    </tbody>
